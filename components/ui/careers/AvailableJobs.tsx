        ...
        <div className="flex flex-col gap-6">
          {jobs.map((job) => (
            <div key={job.id}>
              ...
              <div className="block md:hidden bg-gradient-to-l from-sky-50 to-neutral-50 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              ...
              <div className="hidden md:flex bg-gradient-to-l from-sky-50 to-neutral-50 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
